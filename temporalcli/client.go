...
func (c *ClientOptions) dialClient(cctx *CommandContext) (client.Client, error) {
	...
	if !cctx.RootCommand.DisableConfigEnv {
		oldEnvTLSCert := cctx.Options.EnvLookup.Getenv("TEMPORAL_TLS_CERT")
		oldEnvTLSCertData := cctx.Options.EnvLookup.Getenv("TEMPORAL_TLS_CERT_DATA")
		oldEnvTLSKey := cctx.Options.EnvLookup.Getenv("TEMPORAL_TLS_KEY")
		oldEnvTLSKeyData := cctx.Options.EnvLookup.Getenv("TEMPORAL_TLS_KEY_DATA")
		oldEnvTLSCA := cctx.Options.EnvLookup.Getenv("TEMPORAL_TLS_CA")
		oldEnvTLSCAData := cctx.Options.EnvLookup.Getenv("TEMPORAL_TLS_CA_DATA")
